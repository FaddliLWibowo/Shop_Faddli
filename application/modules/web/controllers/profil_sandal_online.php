...
class Profil_sandal_online extends CI_Controller {
	...
	function index()
	{
		...
		$this->load->view('web/web/bg_top',$data);
		$this->load->view('web/web/bg_left',$data);
		$this->load->view('web/web/bg_profil');
		$this->load->view('web/web/bg_right');
		$this->load->view('web/web/bg_bottom');
	}
}
