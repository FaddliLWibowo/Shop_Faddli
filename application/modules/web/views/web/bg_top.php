...
<a href="<?php echo $this->config->item('site_url');?>web/profil_sandal_online" title="Profil Kami | Grosir Sandal Online"><li><img src="<?php echo base_url(); ?>asset/images/icon-about.png" class="menu-img" border="0" />Tentang Kami</li></a>

<a href="<?php echo $this->config->item('site_url');?>web/cara_belanja" title="Cara Belanja | Grosir Sandal Online"><li><img src="<?php echo base_url(); ?>asset/images/icon-how-to.png" class="menu-img" border="0" />Cara Belanja</li></a>

<a href="<?php echo $this->config->item('site_url');?>web/hubungi_kami" title="Hubungi Kami | Grosir Sandal Online"><li><img src="<?php echo base_url(); ?>asset/images/icon-contact.png" class="menu-img" border="0" />Hubungi Kami</li></a>

<a href="<?php echo $this->config->item('site_url');?>web/site_map" title="Site Map Website | Grosir Sandal Online"><li><img src="<?php echo base_url(); ?>asset/images/icon-sitemap.png" class="menu-img" border="0" />Site Map Produk</li></a>

<a href="<?php echo $this->config->item('site_url');?>web/keranjang" title="Keranjang Belanja | Grosir Sandal Onlinee"><li><img src="<?php echo base_url(); ?>asset/images/icon-shopcart.png" class="menu-img" border="0" />Keranjang Belanja</li></a>
</ul>
</div>
